---
name: triage
description: "User-invoked only. Move issues and external PRs through a state machine of triage roles, categorise, verify, grill if needed, and write agent-ready briefs."
---
